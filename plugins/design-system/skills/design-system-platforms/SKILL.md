...
description: >-
  ...
  @ansavva/design-system resolves to two implementations — a .web.tsx leaf
...
`@ansavva/tokens` is likewise not declared. Install it only if you read
...
<https://ansavva.github.io/design-system/>, which renders both leaves side

...
// `@ansavva/tokens` directly, which is a hard-coded default with no seam:
...
//
// Typing this against `@ansavva/tokens`' `ColorScheme` would need an import
 ...
 * tokens straight out of `@ansavva/tokens` into `StyleSheet.create`, which

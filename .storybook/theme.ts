 ...
 * anything the design system paints. The ACCENT is the blue by
...
/** The blue, for accent SURFACES (the selection pill's gradient). */
const accent = '#0B2A4A';
...
<svg xmlns="http://www.w3.org/2000/svg" width="212" height="56" viewBox="0 0 212 56">
  <text x="0" y="26" font-family="ui-monospace, SFMono-Regular, Menlo, monospace"
        font-size="26" font-weight="700" letter-spacing="0.5" fill="${shell.text}">Andreas Services</text>
...
export const workbenchTheme = create({
  ...
  brandTitle: '@ansavva / design-system',
  brandUrl: 'https://github.com/ansavva/design-system',
